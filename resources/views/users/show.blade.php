    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-md-offset-2">
                <img alt="{{ $user->username }}" width="160" heigth="160" class="center-block img-responsive" src="{{ $user->profile_picture }}">
            </div>
            <div class="col-md-6">
                <h3><b>{{ $user->username }}</b></h3>
                @if($user->id == auth()->id())
                    <a href="#" class="btn btn-primary btn-flat">Edit Profile</a> <a href="#" class="btn btn-default btn-flat"><i class="fa fa-gear"></i> </a>
                @else
